...
const animateBack = (element) => {
  ...
  const translation = translationString(startingPoint.x, startingPoint.y)
  const rotation = rotationString(getRotation(element))
...
const Swiper = ({ flickOnSwipe = true, children, onSwipe, onCardLeftScreen, className, preventSwipe = [] }) => {
